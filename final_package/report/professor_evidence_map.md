...
- `final_package/gui_game_code/run_bci_tracking_game.py`
- `final_package/gui_game_code/bci_tracking_game.py`
- `final_package/gui_game_code/bci_game_runtime.py`
- `final_package/gui_game_code/bci_session_flow.py`
- `final_package/gui_game_code/bci_tracking_game.md`
...
- `final_package/gui_game_code/bci_tracking_game.md` explicitly documents:
  - `45 second baseline`
  - guided collection
  ...
  - `Review + Start Game`
  - gameplay review
- `final_package/gui_game_code/bci_tracking_game.py` contains the actual UI/session-phase logic for baseline, adaptation, readiness, and game start.
...
- `final_package/gui_game_code/bci_game_runtime.py`
- `final_package/gui_game_code/hybrid_bci_tester.py`
- `final_package/report/data_modeling_report_draft.md`
...
- `final_package/gui_game_code/bci_game_runtime.py` loads:
  - `final_package/models/realtime_clench_model.pkl`
  - `final_package/models/clean_left_right_window_model.pkl`
- `final_package/report/data_modeling_report_draft.md` already frames the work as separate scientific questions for jaw and `LEFT/RIGHT`.

## 4. Claim: Jaw Is The Stronger Branch

Primary result evidence:

- `final_package/results/stepwise_benchmark/summary.md`
- `final_package/results/stepwise_benchmark/jaw_stage1/summary.md`
- `final_package/results/stepwise_benchmark/jaw_stage2/summary.md`
- `final_package/results/jaw_click_best_strategy.md`
- `final_package/analysis_code/realtime_clench_detector.py`
...
- `final_package/results/stepwise_benchmark/summary.md`
- `final_package/results/stepwise_benchmark/eeg_stage12_main/summary.md`
- `final_package/results/stepwise_benchmark/eeg_stage12_stress/summary.md`
- `final_package/results/stepwise_benchmark/eeg_stage3/summary.md`
- `final_package/results/left_right_coverage_review.md`
- `final_package/results/eeg_direction_clean_cross_session.md`
- `final_package/analysis_code/run_eeg_direction_clean_cross_session.py`
- `final_package/gui_game_code/bci_game_runtime.py`
- `final_package/gui_game_code/bci_session_flow.py`
...
- `final_package/results/left_right_coverage_review.md`
- `final_package/results/spectral_coverage_review.md`
- `final_package/results/csp_coverage_review.md`
- `final_package/results/eegnet_coverage_review.md`
- `final_package/results/eeg_direction_clean_cross_session.md`
- `final_package/results/lrj_benchmark_summary.md`
...
- time-domain combo baseline
  - `0.628` pooled accuracy / macro-F1 in `spectral_coverage_review.md`
- spectral baselines
  - around `0.508`
- CSP baselines
  - around `0.546`
...
- `final_package/gui_game_code/run_bci_tracking_game.py`
- `final_package/results/stepwise_benchmark/summary.md`
- `final_package/live_run_examples/20260415_103538_live_cyton_Testing-1/`
- `final_package/live_run_examples/20260415_103646_live_cyton_Testing-2/`
- `final_package/live_run_examples/20260415_104152_live_cyton_3/`
...
- `final_package/analysis_code/stepwise_protocol_registry.py`
- `final_package/results/stepwise_benchmark/protocol_registry.csv`
- `final_package/report/dataset_table.md`
...
- `final_package/gui_game_code/run_bci_tracking_game.py`
- `final_package/analysis_code/stepwise_protocol_registry.py`
- `final_package/analysis_code/run_stepwise_benchmark.py`
- `final_package/results/stepwise_benchmark/summary.md`
- `final_package/results/jaw_click_best_strategy.md`
- `final_package/results/left_right_coverage_review.md`
- `final_package/results/lrj_benchmark_summary.md`
- `final_package/results/eeg_direction_clean_cross_session.md`
- selected live run folders from `final_package/live_run_examples/`
