...
DEFAULT_JAW_ARTIFACT = PROJECT_ROOT / "final_package" / "models" / "realtime_clench_model.pkl"
DEFAULT_DIRECTION_ARTIFACT = PROJECT_ROOT / "final_package" / "models" / "clean_left_right_window_model.pkl"
DEFAULT_OUTPUT_ROOT = PROJECT_ROOT / "final_package" / "live_run_examples" / "hybrid_bci_tester"
...
class HybridTesterApp:
    ...
    def _build_ui(self) -> None:
        ...
        self.info_text.insert("1.0", "Logs will be saved under final_package/live_run_examples/hybrid_bci_tester/\n")
