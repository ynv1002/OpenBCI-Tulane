...
- `analysis/lr_event_classifier/` reuses these in-block kept events as labeled `LEFT` / `RIGHT` examples
- `analysis/hybrid_bci_tester.py` reuses the same frozen event-counter logic for `LEFT` / `RIGHT` gating
