# Hand Branch: LRJ LEFT/RIGHT Exact-Count Decode

- Gate pass: `False`

- LRJ files: `Ben-LRJ(1-6)-4:9.csv, Yaniv-LRJ(6)-4:7.csv`
- Pooled constrained exact-count accuracy: `0.458`
- Pooled constrained MAE: `0.875`

## Hand Per-File Summary

| filename | trial_count | constrained_exact_accuracy | constrained_mae |
| --- | --- | --- | --- |
| Ben-LRJ(1-6)-4:9.csv | 12 | 0.5833333333333334 | 0.8333333333333334 |
| Yaniv-LRJ(6)-4:7.csv | 12 | 0.3333333333333333 | 0.9166666666666666 |
