...
DEFAULT_JAW_ARTIFACT = Path(__file__).resolve().parent / "outputs" / "realtime_clench_model.pkl"
DEFAULT_DIRECTION_ARTIFACT = Path(__file__).resolve().parent / "outputs" / "clean_left_right_window_model.pkl"
DEFAULT_OUTPUT_ROOT = Path(__file__).resolve().parent / "outputs" / "hybrid_bci_tester"
DEFAULT_REPLAY_FILES = [
    Path("/Users/yanivnaggar/Desktop/Spring 2026/IS/OPENBCI_runs/Yaniv/EEG_LR/LR-2-27-26-(01).csv"),
    Path("/Users/yanivnaggar/Desktop/Spring 2026/IS/OPENBCI_runs/Yaniv/EEG_LR/LR-3-15-26-(04).csv"),
]
...
class HybridTesterApp:
    ...
    def _build_ui(self) -> None:
        ...
        self.info_text.insert("1.0", "Logs will be saved under analysis/outputs/hybrid_bci_tester/\n")
