...
CONFIG = LRJReviewConfig(
    review_title="Yaniv LRJ Review",
    console_title="Yaniv LRJ review",
    plot_title="Yaniv LRJ review",
    cli_description="One-off Yaniv LRJ structural audit and trial-count review.",
    csv_help="Path to Yaniv-LRJ(6)-4:7.csv.",
