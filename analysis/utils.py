...
FAMILY_SPECS: Dict[str, FamilySpec] = {
    "left_right": FamilySpec(
        ...
        folder=Path("/Users/yanivnaggar/Desktop/Spring 2026/IS/OPENBCI_runs/Yaniv/EEG_LR"),
        filename_prefix="LR",
    ...
    "jaw": FamilySpec(
        ...
        folder=Path("/Users/yanivnaggar/Desktop/Spring 2026/IS/OPENBCI_runs/Yaniv/EMG_JvsN"),
        filename_prefix="HR",
...
def ordered_session_records(family_key: str) -> List[Dict[str, Any]]:
    spec = family_spec(family_key)
    rows = [parse_session_identity(path, family_key) for path in spec.folder.glob("*.csv")]
